...
/*
 * Ce programme permet d'excecuter un nombre souhaité de
 * threads. L'utilisateur dois rentrer le nombre de threads souhaité
 * Paul Fisher
 */
...
void* threadExecute (void* arg){
    ...
    do{
        printf("Vous etes les bienvenus.e.s dans le THREAD \n");
        i++;
    } while(i<=nbreThread);
